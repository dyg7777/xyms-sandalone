...
SET NOTIFY OFF
SET TALK OFF
PUBLIC MAINPATH,SERVERPATH,DLLPATH,REPORTPATH,PROJECTPATH,TOOLSPATH
...
IF VRET=='ok' THEN
SET LIBRARY TO dllpath+'xyms_j.fll'

json=json_create()
json+append(json,json_create('uuid'),

	vret=httppostdata(surl+'/login/','get_enterprise_information')
