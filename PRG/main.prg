...
PUBLIC ENTER_NAME,ENTER_UNCODE,ENTER_START,ENTER_END,ENTER_FREE,VERSION_NUM,APP_NAME,ENTERCODE
...
IF VRET=='ok' THEN
	...
	IF JSON_CHILDS(RETU_VRET)>0 THEN
		FOR X=1 TO JSON_CHILDS(RETU_VRET) STEP 1
			...
			STORE JSON_VALUE(JSON_VALUE(RETU_VRET,X),'enter_code') TO ENTERCODE
