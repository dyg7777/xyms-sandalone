    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AV_name', models.CharField(default='', help_text='收购品种', max_length=50, unique=True)),
                ...
                ('acquisitioncaps', models.DecimalField(decimal_places=4, help_text='收购上限', max_digits=16)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('acquisitionVarietiesid', models.CharField(blank=True, default='', help_text='收购品种', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('varieties_id', models.CharField(blank=True, default='', help_text='品种名称', max_length=50, null=True)),
                ('purchase_id', models.CharField(blank=True, default='', help_text='等级标准', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file_id', models.CharField(blank=True, default='', help_text='对应质检文件ID号', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province_id', models.CharField(blank=True, default='', help_text='省份代码', max_length=20, null=True)),
                ('province_name', models.CharField(default='', help_text='省份名称', max_length=120)),
                ('province_code', models.CharField(default='', help_text='省份简称', max_length=10)),
                ('city_id', models.CharField(blank=True, default='', help_text='城市代码', max_length=20, null=True)),
                ('city_name', models.CharField(default='', help_text='城市名称', max_length=120)),
                ('city_code', models.CharField(default='', help_text='城市简称', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='VehicleType',
